...
public class PrinterReportXLS 
{
    ...
    public PrinterReportXLS(ArrayList<Object[][]> list, String[] column, String title)
    {
        this.column = column;
        this.title = title;
        this.list = list;
        ...
        sheets.add(0,workbook.createSheet("Impresoras"));
        sheets.add(1,workbook.createSheet("Reparaciones"));
