...
View view;
    ...
    private void searchButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton4ActionPerformed
        JOptionPane.showMessageDialog(null,""
            ...
            + "la aplicación no permitirá cargarlo.  \n"
            + "Lo siguiente consiste en seleccionar el equipo\n"
            + " a reemplazar.\n"
            + "Los datos administrativos y de ubicación serán \n"
            + "copiados automaticamente en el nuevo equipo, \n"
            + "en tanto los datos de ubicacion del equipo a \n"
            + "reemplazar se modificarán a DEPOSITO SOPORTE.\n"
            + "Por ultimo se debe presinar el botón cambiar.\n\n"
